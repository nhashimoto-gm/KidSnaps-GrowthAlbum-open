...
### Implemented ✅
- Uploads, Gallery, Filtering, HEIC Support, Rotation, EXIF Extraction, Thumbnails, Bulk Import, Security

### Upcoming (v2.0–v4.0)
- Tags, Date Filtering, Slideshow  
- User Authentication, Sharing, Favorites  
- AI Auto-Tagging, Editing Tools, Cloud Backup  
- Commenting and Timeline View  
- Performance optimization, PWA support, Testing improvements
