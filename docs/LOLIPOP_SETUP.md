...
- **[CLAUDE.md](../CLAUDE.md)** - AI開発ガイド（包括的な技術仕様）
- **[README.md](../README.md)** - プロジェクト概要
- **[REQUIREMENTS.md](./REQUIREMENTS.md)** - 要件定義書
- **[PERFORMANCE_IMPROVEMENT_GUIDE.md](./PERFORMANCE_IMPROVEMENT_GUIDE.md)** - パフォーマンス改善ガイド
- **[HEIC_CONVERSION_WORKFLOW.md](./HEIC_CONVERSION_WORKFLOW.md)** - HEIC変換ワークフロー
- **[DUPLICATE_CHECK_SETUP.md](./DUPLICATE_CHECK_SETUP.md)** - 重複チェック設定
